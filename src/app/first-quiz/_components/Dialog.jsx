...
const Dialog = ({ HandleShowDialog, showDialog, QuizId }) => {
    const { fetchQuizFirst } = useAuth()

    // Handle Delete User
    const HandleDeleteUser = async () => {
        // Delete user logic here
        console.log('User deleted', QuizId);
        HandleShowDialog();
        try {
            const response = await axios.delete(`${process.env.NEXT_PUBLIC_SOME_URL}/api/first-quiz/${QuizId}`)
