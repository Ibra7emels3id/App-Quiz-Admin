...
const Form = ({postId}) => {
    ...
    const fetchUserData = async () => {
        try {
            setLoading(true);
            const res = await axios.get(`${process.env.NEXT_PUBLIC_SOME_URL}/api/user/${id}`);
    ...
    const handleEditUser = async (e) => {
        ...
        try {
            setLoading(true);
            const res = await axios.put(`${process.env.NEXT_PUBLIC_SOME_URL}/api/user/${id}`, formData);
                ...
                <div className="max-w-md w-full mx-auto border border-gray-300 rounded-2xl p-8">
                    <form onSubmit={handleEditUser}>
                        <div className="space-y-6">
                            ...
                            <div>
                                <p className="text-gray-800 text-md font-medium mb-2 block">{formData?.AcademicYear}</p>
                            </div>
                            <div>
